// app/genres/GenresClient.js
'use client'

import { use } from 'react'
import Navigation from '@/app/components/Navigation' // INI UDAH CLIENT COMPONENT
import ResponsiveBreadcrumb from '@/app/components/ResponsiveBreadcrumb'
import Header from '@/app/components/Header'
import Link from 'next/link'
import Image from 'next/image'

export default function GenresClient({ genresPromise }) {
